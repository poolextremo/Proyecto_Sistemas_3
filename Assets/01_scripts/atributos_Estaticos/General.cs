...
public static class General
{
    ...
    public static float dronDamage = 20;

    public static float ballvelocity = 1;
    public static float ballDamage = 10;
    ...
    public static float regen = 0, speed = 0, armadura = 0, criticos = 0, regenLvl = 1, speedLvl = 1, armaduraLvl = 1, criticosLvl = 1,kills = 0;

    public static float experience = 0, time = 0;
